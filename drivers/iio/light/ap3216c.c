 ...
 *
 * Copyright (c) Alderpaw <foxy9855@gmail.com>
 *
 * Data sheets:
...
static const struct iio_chan_spec ap3216c_channels[] = {
        ...
        },
        {
                .type = IIO_PROXIMITY,
                .info_mask_separate = BIT(IIO_CHAN_INFO_RAW),
                .ext_info = ap3216c_prox_ext_info, /* Registering custom attribute */
        },
};

/* Helper for combining Low/High bytes */
...
out_power_down:
        i2c_smbus_write_byte_data(client, AP3426_REG_SYS_CONF, AP3426_SYS_DEV_DOWN);
        return ret;
}
...
static int ap3216c_probe(struct i2c_client *client)
{
        ...
        dev_info(&client->dev, "Initializing AP3216C/AP3426 in power-saving mode...\n");
